...
const sunGeometry = new THREE.SphereGeometry(111, 111, 111); // ------------- SIZING 
...
const ORBIT_SCALE = 9999;   // scales the orbital distances (a)
...
const radius = 9999;    // SCENE RADIUS - CHECK RATIOS W ASTEROID BELT 
