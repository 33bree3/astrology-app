...
const planets = [
  ...
  { name: 'Venus',   data: new Planet(venusData),   radius: 222, planetSize: 18 },
  { name: 'Earth',   data: new Planet(earthData),   radius: 444, planetSize: 21 },
  { name: 'Mars',    data: new Planet(marsData),    radius: 555, planetSize: 15 },
  { name: 'Jupiter', data: new Planet(jupiterData), radius: 777, planetSize: 36 },
  { name: 'Saturn',  data: new Planet(saturnData),  radius: 888, planetSize: 30 },
  { name: 'Uranus',  data: new Planet(uranusData),  radius: 999, planetSize: 24 },
  { name: 'Neptune', data: new Planet(neptuneData), radius: 1010, planetSize: 24 },
];
