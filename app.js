...
const BASE_SCALE = 777;
const PLANET_SIZE_MULTIPLIER = 1;
const TIME_SPEED_FACTOR = 5;
const degToRad = deg => deg * Math.PI / 180;

const orbitalElementsData = {
  Mercury: { a: 0.3871, e: 0, i: degToRad(7.005),   o: degToRad(48.331),  w: degToRad(29.124) },
  ...
  Neptune: { a: 30.110, e: 0, i: degToRad(1.770),   o: degToRad(131.784), w: degToRad(272.846) }
};
